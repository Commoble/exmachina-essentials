...
import commoble.exmachinaessentials.content.turbine.SteamTurbineBlock;
...
public class BlockRegistrar
{
	...
	public static final RegistryObject<BatteryBoxBlock> BATTERY_BOX = registerBlock(Names.BATTERY_BOX, BatteryBoxBlock::new, AbstractBlock.Properties.from(Blocks.CRAFTING_TABLE));
	public static final RegistryObject<SteamTurbineBlock> STEAM_TURBINE = registerBlock(Names.STEAM_TURBINE, SteamTurbineBlock::new, AbstractBlock.Properties.from(Blocks.BLAST_FURNACE));
